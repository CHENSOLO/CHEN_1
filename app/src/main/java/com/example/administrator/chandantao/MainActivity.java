package com.example.administrator.chandantao;
...
public class MainActivity extends AppCompatActivity implements ViewPager.OnPageChangeListener, TabHost.OnTabChangeListener {
    ...
    private int imageViewArray[] = {R.drawable.tab_train_btn, R.drawable.tab_mine_btn, R.drawable.tab_add_btn, R.drawable.tab_home_btn};
    private String textViewArray[] = {"训练", "动态", "增加", "星标"};
    ...
    private void initView() {
        ...
        //实例化FragmentTabHost对象进行绑定
        mTabHost = (FragmentTabHost) findViewById(android.R.id.tabhost);//绑定tahost
        mTabHost.setup(this, getSupportFragmentManager(), R.id.pager);//绑定VIEWpage
